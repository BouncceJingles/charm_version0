...
<html lang="en">
  <head>
    ...
    <style>
      ...
      .no-nric, .cannot-find, .not-resident  {
        display: none;
      }
      .display {
  ...
  <body style>
    ...
    <div class="container">
      <div class="check-nric">
        ...
        <div class="error not-resident alert alert-warning">This is not a valid resident.</div>
    ...
    <script>
      $(document).ready(function(){
        ...
        function submitnric() {
          ...
          else if($("#txtNric").val().length != 9)
          {
            $(".not-resident").fadeIn('slow');
            $("#txtNric").focus();
          }
          else
          {
        ...
        function setGrid(activitiesData){
          ...
          if($(".check-nric").length > 0){
            if(!isResident)
            {
              //$(".container").append('<div class="error no-nric alert alert-danger">Please enter NRIC!</div><div class="error cannot-find alert alert-warning">No result found!</div><div class="display"></div>');
              //$(".navbar-collapse").append('<div class="navbar-form navbar-right get-record"><input type="text" class="form-control input-sm" placeholder="Enter nric" name="txtNric" id="txtNric" autocomplete="off" autofocus><button class="btn btn-default btn-sm" type="submit" value="Get Record" id="submit">Get Record</button></div><div class="error no-nric alert alert-danger">Please enter NRIC!</div><div class="error cannot-find alert alert-warning">No result found!</div><div class="display"></div>');
